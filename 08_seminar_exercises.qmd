...
```{r}
setwd("PATH_TO_GITHUB")
library(reticulate)
use_python("PATH_TO_PYTHON", required = TRUE)
```

Let's also load the required Python packages! The below function should try to import the necessary packages and if, if they're not installed, install them. 
...
math_student <- read.csv("/Users/christycoulson/Documents/Jobs/Work/Academia/Teaching/ME314/24-25/Seminars/Seminar 8/Data/math_student.csv", sep = ",", header = TRUE) %>%
select(__)
